...
export const SEED_TAXA: Taxon[] = [
  ...
  },
  {
    ...
    korName: "생강나무",
    aliases: ["yellow", "노란꽃"], // SEED_CONTENT funFact: "이른 봄 노란 꽃이 먼저 펴요"
    rank: "species",
    group: "plant",
    seasonTags: ["spring"],
    habitatTags: ["mountain"],
  ...
  },
  {
    ...
    group: "plant",
    seasonTags: ["summer"],
    habitatTags: ["field", "neighborhood"],
    riskTags: [],
    rarity: "common",
  ...
  },
  {
    ...
    group: "plant",
    seasonTags: ["spring"],
    habitatTags: ["park", "field", "neighborhood"],
    riskTags: [],
    rarity: "common",
  ...
  },
  {
    ...
    korName: "애기똥풀",
    aliases: ["yellow", "노란꽃"], // SEED_CONTENT funFact: "노란 꽃잎을 봐요"
    rank: "species",
    group: "plant",
    seasonTags: ["spring"],
    habitatTags: ["field", "neighborhood"],
  ...
  },
  {
    ...
    group: "plant",
    seasonTags: ["summer"],
    habitatTags: ["garden", "neighborhood"],
    riskTags: [],
    rarity: "common",
    sizeDescription: "키가 10~30cm 정도로 낮게 자라요",
    activeTime: "day",
  ...
  },
  {
    ...
    group: "bird",
    seasonTags: [],
    habitatTags: ["park", "neighborhood", "garden"],
    riskTags: [],
    rarity: "common",
  ...
  },
  {
    ...
    group: "bird",
    seasonTags: [],
    habitatTags: ["mountain", "park", "neighborhood"],
    riskTags: [],
    rarity: "common",
  ...
  },
  {
    ...
    group: "bird",
    seasonTags: [],
    habitatTags: ["park", "garden", "mountain"],
    riskTags: [],
    rarity: "common",
  ...
  },
  {
    ...
    group: "bird",
    seasonTags: [],
    habitatTags: ["waterside", "neighborhood"],
    riskTags: [],
    rarity: "common",
  ...
  },
  {
    ...
    group: "bird",
    seasonTags: [],
    habitatTags: ["park", "neighborhood", "mountain"],
    riskTags: [],
    rarity: "common",
...
export const SEED_QUESTS: Quest[] = [
  ...
  // ── 계절 퀘스트 확장(2026-07-28) ──────────────────────────────────────
  // 실제 노출은 QuestEngine.isSeasonallyVisible이 criteria.season과 오늘 날짜(Asia/Seoul
  // 기준)를 비교해 결정한다(activeFrom/activeTo는 로테이션용이 아니라 항상 열어둠) —
  // 그래서 이 4계절 세트는 1회성 시딩만으로 매년 자동으로 돌아온다.
  {
    id: "quest-spring-insects",
    type: "seasonal",
    title: "봄이 왔어요! 곤충 친구 3종 🐝",
    description: "봄에 만날 수 있는 곤충 친구 세 종류를 관찰해요.",
    criteria: { distinctTaxa: 3, season: "spring", group: "insect" },
    reward: { xp: 25 },
    activeFrom: "2026-01-01T00:00:00.000Z",
    curriculumTags: ["통합교과-봄"],
  },
  {
    id: "quest-summer-insects",
    type: "seasonal",
    title: "여름 곤충 대탐험 3종 🦗",
    description: "여름에 활발히 움직이는 곤충 친구 세 종류를 찾아보아요.",
    criteria: { distinctTaxa: 3, season: "summer", group: "insect" },
    reward: { xp: 25 },
    activeFrom: "2026-01-01T00:00:00.000Z",
    curriculumTags: ["통합교과-여름"],
  },
  {
    id: "quest-summer-plants",
    type: "seasonal",
    title: "여름의 초록 식물 3종 🌿",
    description: "여름에 무성하게 자라는 식물 세 종류를 관찰해요.",
    criteria: { distinctTaxa: 3, season: "summer", group: "plant" },
    reward: { xp: 25 },
    activeFrom: "2026-01-01T00:00:00.000Z",
    curriculumTags: ["통합교과-여름"],
  },
  {
    id: "quest-autumn-plants",
    type: "seasonal",
    title: "가을 열매와 단풍 3종 🍂",
    description: "가을에 열매를 맺거나 단풍이 드는 식물 세 종류를 찾아보아요.",
    criteria: { distinctTaxa: 3, season: "autumn", group: "plant" },
    reward: { xp: 25 },
    activeFrom: "2026-01-01T00:00:00.000Z",
    curriculumTags: ["통합교과-가을"],
  },
  {
    id: "quest-autumn-insects",
    type: "seasonal",
    title: "가을 풀밭의 폴짝이 3종 🦋",
    description: "가을 풀밭에서 만날 수 있는 곤충 세 종류를 관찰해요.",
    criteria: { distinctTaxa: 3, season: "autumn", group: "insect" },
    reward: { xp: 25 },
    activeFrom: "2026-01-01T00:00:00.000Z",
    curriculumTags: ["통합교과-가을"],
  },
  {
    id: "quest-winter-waterbirds",
    type: "seasonal",
    title: "겨울에도 만나는 물새 3종 🦆",
    description: "겨울에도 물가에서 볼 수 있는 새 세 종류를 관찰해요.",
    criteria: { distinctTaxa: 3, season: "winter", habitat: "waterside", group: "bird" },
    reward: { xp: 25 },
    activeFrom: "2026-01-01T00:00:00.000Z",
    curriculumTags: ["과학-동물의생활"],
  },
